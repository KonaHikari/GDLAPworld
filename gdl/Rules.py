...
base_rules = [
    # connections
    {
        ...
        ConnectionNames.hub1_east: lambda player: lambda state: state.has(ItemNames.e_wing_key, player) and \
                state.has_group("CenAndWest", player,3),
    ...
    {ItemNames.runes: {
            ...
            LocationNames.runes_dw_01: lambda player: lambda state: state.has(ItemNames.e_wing_key, player) and \
                state.has(ItemNames.region_key_dw, player),
            ...
            LocationNames.runes_bf_01: lambda player: lambda state: state.has(ItemNames.l_tower_key, player) and \
                state.has(ItemNames.region_key_bf, player),
            LocationNames.runes_bf_01: lambda player: lambda state: state.has(ItemNames.l_tower_key, player) and \
            ...
            LocationNames.lw_loc_fr: lambda player: lambda state: state.has(ItemNames.region_key_fr, player) and \
                state.has(ItemNames.w_wing_key, player),
            LocationNames.lw_loc_dl: lambda player: lambda state: state.has(ItemNames.region_key_dl, player) and \
                state.has(ItemNames.e_wing_key, player),
            LocationNames.lw_loc_id: lambda player: lambda state: state.has(ItemNames.region_key_id, player) and \
                state.has(ItemNames.e_wing_key, player),
            LocationNames.lw_loc_dw: lambda player: lambda state: state.has(ItemNames.region_key_dw, player) and \
                state.has(ItemNames.e_wing_key, player),
            ...
            LocationNames.tr_fr: lambda player: lambda state: state.has(ItemNames.region_key_fr, player) and \
                state.has(ItemNames.w_wing_key, player),
            LocationNames.tr_dl: lambda player: lambda state: state.has(ItemNames.region_key_dl, player) and \
                state.has(ItemNames.e_wing_key, player),
            LocationNames.tr_id: lambda player: lambda state: state.has(ItemNames.region_key_id, player) and \
                state.has(ItemNames.e_wing_key, player),
            LocationNames.tr_dw: lambda player: lambda state: state.has(ItemNames.region_key_dw, player) and \
                state.has(ItemNames.e_wing_key, player),
...
region_key_rules = [
    ...
    {        ItemNames.runes: {
            LocationNames.runes_mk_01: lambda player: lambda state: state.has(ItemNames.region_key_mk, player),
            LocationNames.runes_cs_01: lambda player: lambda state: state.has(ItemNames.region_key_cs, player),
            LocationNames.runes_sd_01: lambda player: lambda state: state.has(ItemNames.region_key_sd, player),
            LocationNames.runes_sd_02: lambda player: lambda state: state.has(ItemNames.region_key_sd, player),
            LocationNames.runes_fr_01: lambda player: lambda state: state.has(ItemNames.region_key_fr, player),
            LocationNames.runes_dl_01: lambda player: lambda state: state.has(ItemNames.region_key_dl, player),
            LocationNames.runes_id_01: lambda player: lambda state: state.has(ItemNames.region_key_id, player),
            LocationNames.runes_id_02: lambda player: lambda state: state.has(ItemNames.region_key_id, player),
            LocationNames.runes_dw_01: lambda player: lambda state: state.has(ItemNames.region_key_dw, player),
            LocationNames.runes_dw_02: lambda player: lambda state: state.has(ItemNames.region_key_dw, player),
            LocationNames.runes_bf_01: lambda player: lambda state: state.has(ItemNames.region_key_bf, player),
        },
...
def set_rules(world: MultiWorld, options: GDLOptions, player: int):
    allowed_loc_types = [ItemNames.runes,ItemNames.shard,ItemNames.lw,ItemNames.region_key,ItemNames.wing_key]
