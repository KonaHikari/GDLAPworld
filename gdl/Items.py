...
item_table = {
    ...
    ItemNames.lw_mk: ItemData(base_id + 21, ItemClassification.progression),
    ItemNames.lw_cs: ItemData(base_id + 22, ItemClassification.progression),
    ItemNames.lw_sd: ItemData(base_id + 23, ItemClassification.progression),
    ItemNames.lw_fr: ItemData(base_id + 24, ItemClassification.progression),
    ItemNames.lw_dl: ItemData(base_id + 26, ItemClassification.progression),
    ItemNames.lw_id: ItemData(base_id + 27, ItemClassification.progression),
    ItemNames.lw_dw: ItemData(base_id + 28, ItemClassification.progression),
    ItemNames.lw_dt: ItemData(base_id + 29, ItemClassification.progression),
    # region keys
